...
let PropertyInputForm = (props) => {
	...
	const { currentUser, contacts, history, users, handleItemSubmit, propertiesMediaFiles, handleItemDelete } = props
							...
							<Grid sm={6} container item spacing={9} direction="column">
								...
								>
									<Grid item>
										...
										<Typography variant="subtitle1">Unit Comforts</Typography>
									</Grid>
