...
export function getPropertyBaths () {
	...
	return	baths.concat(['1.5 Baths','2.5 Baths', '3.5 Baths', '4.5 Baths', '5.5 Baths'])
}
...
export function getCheckOptions () {
	let check_options = []
	for(let i=1; i<13; i++){
		i === 1 ? check_options.push(i+ ' Check') : check_options.push(i+' Checks');
	}
...
export function getLeaseOptions() {
	let lease_options = ['Short Term', 'Long Term', 'Fixed Term', 'Student', 'Commercial']
